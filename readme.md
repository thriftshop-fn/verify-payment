...
- Click Change Site Name `${username}-tss-fn-verify-payment.${domain}.com`

## Production

- make post request with Needed *payload* to `${username}-tss-fn-verify-payment.${domain}.com/api`